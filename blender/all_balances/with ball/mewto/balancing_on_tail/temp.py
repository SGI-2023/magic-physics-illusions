...
# PARAMETERS
mesh_name = "mewto"
our_name = "mewto_with_ball"
armature_name = "Armature"
useless_bone = "wrist"
my_dir = "/Users/unaicaja/Library/CloudStorage/OneDrive-Personal/blender playground/cool results with ball/mewto/balancing_on_tail"
...
def objective_function(params):
    ...
    if using_ball:
        ...
        obj_fun = -params["ball_coef"]*np.log(obj_fun)
...
params = {
    ...
    "w2" : 1,
    "ball_coef" : 10,
    "min_r" : 1e-4,# Minimum radius for the ball
    "mdto": 1e-4,
    "reg_coef" : 3,
    "diff_step_bone": 1e-4,
    "diff_step_ball": 1e-5,
